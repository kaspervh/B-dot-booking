...
class WorkPeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_period" do
    assert_difference('WorkPeriod.count') do
      post work_periods_url, params: { work_period: { company_id: @work_period.company_id, end_time: @work_period.end_time, start_time: @work_period.start_time, user_id: @work_period.user_id } }
    end
  ...
  test "should update work_period" do
    patch work_period_url(@work_period), params: { work_period: { company_id: @work_period.company_id, end_time: @work_period.end_time, start_time: @work_period.start_time, user_id: @work_period.user_id } }
